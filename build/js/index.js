...
/***/ function(module, exports, __webpack_require__) {
	...
	var _caller = __webpack_require__(180);

	var _caller2 = _interopRequireDefault(_caller);

	var _Language = __webpack_require__(182);
	...
	var _Screenshots = __webpack_require__(186);
	...
	var callers = {
	    fetchAppStoreData: function fetchAppStoreData(callback) {
	        _jquery2.default.ajax({
	            url: 'https://itunes.apple.com/lookup?id=' + _constants2.default.appstoreId,
	            dataType: 'jsonp',
	    ...
	    _createClass(Language, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                this.props.language === 'ru' ? _react2.default.createElement(
	                    'p',
	                    null,
	                    'English'
	...
	var Header = function (_Component) {
	    ...
	    _createClass(Header, [{
	        ...
	        value: function iosClick() {
	            var country = this.props.language === 'ru' ? 'ru' : 'us';
	            window.location.href = 'https://itunes.apple.com/' + country + '/app/id' + _constants2.default.appstoreId;
	        }
	    }, {
	        key: 'androidClick',
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'subheader' },
	                    _react2.default.createElement('h2', { dangerouslySetInnerHTML: { __html: _helper2.default.loc(this.props.language, 'visual workout log<br/>for professionals') } })
	                ),
	                _react2.default.createElement(
	                    'div',
	                    ...
	                    this.props.iosSize && _react2.default.createElement(
	                        'div',
	                        { className: 'fileSize' },
	                        _helper2.default.bytesToSize(this.props.iosSize)
	                    )
	                ),
	                _react2.default.createElement(
	                    'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ru = __webpack_require__(185);
	...
	var H = {
	    ...
	    loc: function loc(lang, val) {
	        if (lang === 'ru') {
	            return _ru2.default[val];
	        }
	        return val;
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Screenshots = function (_Component) {
	    ...
	    function Screenshots() {
	        ...
	        return _possibleConstructorReturn(this, (Screenshots.__proto__ || Object.getPrototypeOf(Screenshots)).apply(this, arguments));
	    }
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'h2',
	                        null,
	                        _helper2.default.loc(this.props.language, 'Screenshots')
	                    ),
	                    _react2.default.createElement('div', { className: 'line' })
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'shotsContainer wide' },
	                    this.props.screenshotUrls.map(function (scrUrl, i) {
